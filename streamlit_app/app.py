...
PAGES = {
    ...
    "Unidad 5 — Tren de pulsos (Nyquist, ISI, ojo)": [
        st.Page(u5_muestreo.render, title="Teorema de muestreo", url_path="u5-muestreo"),
        st.Page(u5_psd.render, title="Densidad espectral (PSD)", url_path="u5-psd"),
        st.Page(u5_nyquist.render, title="Criterio de Nyquist", url_path="u5-nyquist"),
        st.Page(u5_rrc.render, title="Coseno realzado / RRC", url_path="u5-rrc"),
        st.Page(u5_ojo.render, title="ISI y diagrama de ojo", icon="👁",
                url_path="u5-ojo"),
        st.Page(u5_lab3.render, title="Muestreo y filtrado (Lab 3)", url_path="u5-lab3"),
        st.Page(u5_simulador.render, title="Simulador BPSK", url_path="u5-simulador"),
        st.Page(u5_sincronizacion.render, title="Sincronización",
                url_path="u5-sincronizacion"),
    ],
}
